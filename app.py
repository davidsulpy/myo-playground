import os, sys
os.environ["PYTHONPATH"] = "/Users/davidsulpy/code/initialstate/myo/myo-python"
os.environ["DYLD_LIBRARY_PATH"] = "$DYLD_LIBRARY_PATH:/Library/frameworks/myo.framework"
